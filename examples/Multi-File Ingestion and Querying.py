# -*- coding: utf-8 -*-
"""
Example 2: Ingest multiple files and ask questions across documents.
"""
...
OpenDatabase("multiDB", "./vectorDB")

# Ingest multiple documents
IngestFile("./ExampleFiles/Sample_TXT.txt", "multiDB")
IngestFile("./ExampleFiles/Sample_PDF.pdf", "multiDB")
IngestFile("./ExampleFiles/Sample_DOCX.docx", "multiDB")

# Ask a question requiring info from multiple files
question = "Summarize information about all the documents"
